...
public class SpinnerContinuousCollider : ContinuousCollider, IBoostFireRate
{
    [SerializeField, BoxGroup("Visual")] Transform spinnerTransform;
    [SerializeField, BoxGroup("Visual")] Vector3 spinnerAxis = Vector3.right;
