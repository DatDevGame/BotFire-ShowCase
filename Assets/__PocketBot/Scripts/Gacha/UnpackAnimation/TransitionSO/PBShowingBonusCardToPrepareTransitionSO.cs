...
[CreateAssetMenu(fileName = "PB_ShowingBonusCard - PrepareTransitionSO", menuName = "PocketBots/Gacha/UnpackAnimation/TransitionSO/PBShowingBonusCardToPrepareTransitionSO")]
public class PBShowingBonusCardToPrepareTransitionSO : ShowingCardToSummaryTransitionSO
{
    readonly ShowingBonusCardToPrepareEvent transitionEvent = new();
    ...
    protected class ShowingBonusCardToPrepareEvent : ShowingCardToSummaryEvent
    {
